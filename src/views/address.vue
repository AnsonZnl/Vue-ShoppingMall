        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  <li v-for="(item,index) in addressListFilter" :class="{'check':selectedAddrIdCheck==index}" @click="selectedAddrIdCheck=index;selectedAddrId=item.addressId">
                    <dl>
                      <dt>{{item.userName}}</dt>
      ...
      methods:{
        init(){          
          axios.get("/users/addressList").then((res)=>{
            ...
            this.selectedAddrIdCheck=this.checkIndex;
            this.addressList.forEach((item)=>{
              if(item.isDefault==1){
