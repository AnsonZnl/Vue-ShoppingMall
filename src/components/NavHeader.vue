  ...
  <div class="navbar">
    ...
    <div class="navbar-right-container" style="display: flex;">
      <div class="navbar-menu-container">
        ...
        <a href="javascript:void(0)" class="navbar-link" @click="goLogin" v-if="!nickName">Login</a>
   ...
   <div class="md-modal modal-msg md-modal-transition md-show" v-show="loginModelFlag">
   ...
   <div class="md-overlay" v-show="loginModelFlag" @click="hideLogin"></div>
</header>
</template>
    ...
    methods:{
      ...
      getCartCount(){
        axios.get("/users/getCartCount").then((response)=>{
          let res=response.data;
          if(res.status==0){
            this.$store.commit("cartCount",res.result);
          }
        })
      },
      goLogin(){
